...
Gem::Specification.new do |s|
  ...
  s.files = ["bin/locarails", "bin/locarails.cmd", "lib/locarails", "lib/locarails/base.rb", "lib/locarails/copy.rb", "lib/locarails/fix.rb", "lib/locarails/git.rb", "lib/locarails/none.rb", "lib/locarails/version.rb", "lib/locarails.rb", "templates/database.locaweb.yml.erb", "templates/deploy.common.rb.erb", "templates/deploy.rb.erb", "templates/locaweb_backup.rb", "templates/ssh_helper.rb", "tasks/gems.rake", "templates/.gitignore"]
